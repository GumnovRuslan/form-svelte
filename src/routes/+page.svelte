<script>
	...
	import { PUBLIC_URL1, PUBLIC_URL2 } from '$env/static/public';
	...
	function changeContent() {
		...
		function contacts() {
			...
			contactsData.description.placeholder = i18next.t(`form:contacts.text`, {
				context: 'description'
			});
		...
		function communication() {
			...
			languagesData.another_placeholder = i18next.t(`form:communication.another`, {
				context: 'placeholder'
			});
		}
		function preference() {
		...
		function categories() {
			...
			categoriesFull.categories[0].subcategories[0].name = i18next.t(
				`form:category.categories.0.subcategories.0`
			);
			categoriesFull.categories[0].subcategories[1].name = i18next.t(
				`form:category.categories.0.subcategories.1`
			);
			categoriesFull.categories[0].subcategories[2].name = i18next.t(
				`form:category.categories.0.subcategories.2`
			);
			categoriesFull.categories[0].subcategories[3].name = i18next.t(
				`form:category.categories.0.subcategories.3`
			);
			categoriesFull.categories[0].subcategories[4].name = i18next.t(
				`form:category.categories.0.subcategories.4`
			);
			categoriesFull.categories[0].subcategories[5].name = i18next.t(
				`form:category.categories.0.subcategories.5`
			);
			categoriesFull.categories[0].subcategories[6].name = i18next.t(
				`form:category.categories.0.subcategories.6`
			);

			categoriesFull.categories[1].name = i18next.t(`form:category.categories.1.name`);
			categoriesFull.categories[1].subcategories[0].name = i18next.t(
				`form:category.categories.1.subcategories.0`
			);
			categoriesFull.categories[1].subcategories[1].name = i18next.t(
				`form:category.categories.1.subcategories.1`
			);
			categoriesFull.categories[1].subcategories[2].name = i18next.t(
				`form:category.categories.1.subcategories.2`
			);
			categoriesFull.categories[1].subcategories[3].name = i18next.t(
				`form:category.categories.1.subcategories.3`
			);
			categoriesFull.categories[1].subcategories[4].name = i18next.t(
				`form:category.categories.1.subcategories.4`
			);
			categoriesFull.categories[1].subcategories[5].name = i18next.t(
				`form:category.categories.1.subcategories.5`
			);
			categoriesFull.categories[1].subcategories[6].name = i18next.t(
				`form:category.categories.1.subcategories.6`
			);

			categoriesFull.categories[2].name = i18next.t(`form:category.categories.2.name`);
			categoriesFull.categories[2].subcategories[0].name = i18next.t(
				`form:category.categories.2.subcategories.0`
			);
			categoriesFull.categories[2].subcategories[1].name = i18next.t(
				`form:category.categories.2.subcategories.1`
			);
			categoriesFull.categories[2].subcategories[2].name = i18next.t(
				`form:category.categories.2.subcategories.2`
			);
			categoriesFull.categories[2].subcategories[3].name = i18next.t(
				`form:category.categories.2.subcategories.3`
			);
			categoriesFull.categories[2].subcategories[4].name = i18next.t(
				`form:category.categories.2.subcategories.4`
			);
			categoriesFull.categories[2].subcategories[5].name = i18next.t(
				`form:category.categories.2.subcategories.5`
			);
			categoriesFull.categories[2].subcategories[6].name = i18next.t(
				`form:category.categories.2.subcategories.6`
			);
			categoriesFull.categories[2].subcategories[7].name = i18next.t(
				`form:category.categories.2.subcategories.7`
			);
			categoriesFull.categories[2].subcategories[8].name = i18next.t(
				`form:category.categories.2.subcategories.8`
			);
			categoriesFull.categories[2].subcategories[9].name = i18next.t(
				`form:category.categories.2.subcategories.9`
			);
			categoriesFull.categories[2].subcategories[10].name = i18next.t(
				`form:category.categories.2.subcategories.10`
			);
			categoriesFull.categories[2].subcategories[11].name = i18next.t(
				`form:category.categories.2.subcategories.11`
			);
			categoriesFull.categories[2].subcategories[12].name = i18next.t(
				`form:category.categories.2.subcategories.12`
			);
			categoriesFull.categories[2].subcategories[13].name = i18next.t(
				`form:category.categories.2.subcategories.13`
			);

			categoriesFull.categories[3].name = i18next.t(`form:category.categories.3.name`);
			categoriesFull.categories[3].subcategories[0].name = i18next.t(
				`form:category.categories.3.subcategories.0`
			);
			categoriesFull.categories[3].subcategories[1].name = i18next.t(
				`form:category.categories.3.subcategories.1`
			);
			categoriesFull.categories[3].subcategories[2].name = i18next.t(
				`form:category.categories.3.subcategories.2`
			);
			categoriesFull.categories[3].subcategories[3].name = i18next.t(
				`form:category.categories.3.subcategories.3`
			);
			categoriesFull.categories[3].subcategories[4].name = i18next.t(
				`form:category.categories.3.subcategories.4`
			);
			categoriesFull.categories[3].subcategories[5].name = i18next.t(
				`form:category.categories.3.subcategories.5`
			);

			categoriesFull.categories[4].name = i18next.t(`form:category.categories.4.name`);
			categoriesFull.categories[4].subcategories[0].name = i18next.t(
				`form:category.categories.4.subcategories.0`
			);
			categoriesFull.categories[4].subcategories[1].name = i18next.t(
				`form:category.categories.4.subcategories.1`
			);
			categoriesFull.categories[4].subcategories[2].name = i18next.t(
				`form:category.categories.4.subcategories.2`
			);
			categoriesFull.categories[4].subcategories[3].name = i18next.t(
				`form:category.categories.4.subcategories.3`
			);
			categoriesFull.categories[4].subcategories[4].name = i18next.t(
				`form:category.categories.4.subcategories.4`
			);
			categoriesFull.categories[4].subcategories[5].name = i18next.t(
				`form:category.categories.4.subcategories.5`
			);
			categoriesFull.categories[4].subcategories[6].name = i18next.t(
				`form:category.categories.4.subcategories.6`
			);

			categoriesFull.categories[5].name = i18next.t(`form:category.categories.5.name`);
			categoriesFull.categories[5].subcategories[0].name = i18next.t(
				`form:category.categories.5.subcategories.0`
			);
			categoriesFull.categories[5].subcategories[1].name = i18next.t(
				`form:category.categories.5.subcategories.1`
			);
			categoriesFull.categories[5].subcategories[2].name = i18next.t(
				`form:category.categories.5.subcategories.2`
			);
			categoriesFull.categories[5].subcategories[3].name = i18next.t(
				`form:category.categories.5.subcategories.3`
			);
			categoriesFull.categories[5].subcategories[4].name = i18next.t(
				`form:category.categories.5.subcategories.4`
			);
			categoriesFull.categories[5].subcategories[5].name = i18next.t(
				`form:category.categories.5.subcategories.5`
			);
			categoriesFull.categories[5].subcategories[6].name = i18next.t(
				`form:category.categories.5.subcategories.6`
			);

			categoriesFull.categories[6].name = i18next.t(`form:category.categories.6.name`);
			categoriesFull.categories[6].subcategories[0].name = i18next.t(
				`form:category.categories.6.subcategories.0`
			);
			categoriesFull.categories[6].subcategories[1].name = i18next.t(
				`form:category.categories.6.subcategories.1`
			);
			categoriesFull.categories[6].subcategories[2].name = i18next.t(
				`form:category.categories.6.subcategories.2`
			);
			categoriesFull.categories[6].subcategories[3].name = i18next.t(
				`form:category.categories.6.subcategories.3`
			);
			categoriesFull.categories[6].subcategories[4].name = i18next.t(
				`form:category.categories.6.subcategories.4`
			);
			categoriesFull.categories[6].subcategories[5].name = i18next.t(
				`form:category.categories.6.subcategories.5`
			);

			categoriesFull.categories[7].name = i18next.t(`form:category.categories.7.name`);
			categoriesFull.categories[7].subcategories[0].name = i18next.t(
				`form:category.categories.7.subcategories.0`
			);
			categoriesFull.categories[7].subcategories[1].name = i18next.t(
				`form:category.categories.7.subcategories.1`
			);
			categoriesFull.categories[7].subcategories[2].name = i18next.t(
				`form:category.categories.7.subcategories.2`
			);
			categoriesFull.categories[7].subcategories[3].name = i18next.t(
				`form:category.categories.7.subcategories.3`
			);

			categoriesFull.categories[8].name = i18next.t(`form:category.categories.8.name`);
			categoriesFull.categories[8].subcategories[0].name = i18next.t(
				`form:category.categories.8.subcategories.0`
			);
			categoriesFull.categories[8].subcategories[1].name = i18next.t(
				`form:category.categories.8.subcategories.1`
			);
			categoriesFull.categories[8].subcategories[2].name = i18next.t(
				`form:category.categories.8.subcategories.2`
			);
			categoriesFull.categories[8].subcategories[3].name = i18next.t(
				`form:category.categories.8.subcategories.3`
			);

			categoriesFull.categories[9].name = i18next.t(`form:category.categories.9.name`);
			categoriesFull.categories[9].subcategories[0].name = i18next.t(
				`form:category.categories.9.subcategories.0`
			);
			categoriesFull.categories[9].subcategories[1].name = i18next.t(
				`form:category.categories.9.subcategories.1`
			);
			categoriesFull.categories[9].subcategories[2].name = i18next.t(
				`form:category.categories.9.subcategories.2`
			);
			categoriesFull.categories[9].subcategories[3].name = i18next.t(
				`form:category.categories.9.subcategories.3`
			);
			categoriesFull.categories[9].subcategories[4].name = i18next.t(
				`form:category.categories.9.subcategories.4`
			);

			categoriesFull.categories[10].name = i18next.t(`form:category.categories.10.name`);
			categoriesFull.categories[10].subcategories[0].name = i18next.t(
				`form:category.categories.10.subcategories.0`
			);
			categoriesFull.categories[10].subcategories[1].name = i18next.t(
				`form:category.categories.10.subcategories.1`
			);
			categoriesFull.categories[10].subcategories[2].name = i18next.t(
				`form:category.categories.10.subcategories.2`
			);
			categoriesFull.categories[10].subcategories[3].name = i18next.t(
				`form:category.categories.10.subcategories.3`
			);
			categoriesFull.categories[10].subcategories[4].name = i18next.t(
				`form:category.categories.10.subcategories.4`
			);
		}
	}
	...
	async function sendForm(e) {
		...
		try {
			const response1 = await fetch(PUBLIC_URL1 + formData.category.name.toUpperCase(), {
				method: 'POST',
				headers: {
			...
			const response2 = await fetch(PUBLIC_URL2, {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json'
				},
			...
			if (response1.ok && response2.ok) {
				...
				formMessage =
					i18next.t(`form:button.message`, { context: 'error_server' }) + response1.status;
		...
		function getFormData() {
			...
			function getWorkLike(id) {
				...
				return radios[0].checked ? inputs[0].value : radios[1].checked ? inputs[1].value : null;
			}
			...
			function getCommunicationLanguages(id) {
				...
				const getData = (id) =>
					inputs[id].checked
						? inputs[id].closest('.languages__item').querySelector('.languages__item-text')
								.textContent
						: '';
				...
				return {
					...
					another: inputs[5].checked
						? inputs[5].closest('.languages__item-another').querySelector('input[type="text"]')
								.value
						: ''
				};
			}
			...
			function getCategory(id) {
				...
				let subcategories =
					container.querySelector('#subcategorySelect').dataset.subcategoriesSelect;
...
<Header
	{langs}
	active={selectLangId}
	on:selectLang={(e) => i18next.changeLanguage(e.detail.value)}
/>
<main class="main">
	...
	<div class="form" name="myForm" id="myForm">
		...
		>
			<div
				class="form__inner-image"
				id="formImage"
				style="display: {activeFormIndex ? 'none' : 'block'}"
			>
			...
			<div class="form__content">
				...
				<form
					class="form-stage"
					id="formStep1"
					style="display: {activeFormIndex == 0 ? 'flex' : 'none'}"
					on:submit={nextStep}
				>
				...
				<form
					class="form-stage"
					id="formStep2"
					style="display: {activeFormIndex == 1 ? 'flex' : 'none'}"
					on:submit={validateFormStep2}
				>
					<div class="form-stage__inner">
				...
				<form
					class="form-stage"
					id="formStep3"
					style="display: {activeFormIndex == 2 ? 'flex' : 'none'}"
					on:submit={nextStep}
				>
					<div class="form-stage__inner">
				...
				<form
					class="form-stage"
					id="formStep4"
					style="display: {activeFormIndex == 3 ? 'flex' : 'none'}"
					on:submit={validateFormStep4}
				>
					<div class="form-stage__inner">
					...
					<div class="form__bottom">
						<button
							class="button form__bottom-btn"
							type="submit"
							id="buttonSend"
							class:form__bottom-btn--disabled={buttonIsDisabled}>Registration</button
						>
						<p class="form__bottom-message" class:form__bottom-message-error={formMessageIsError}>
							{formMessage}
						</p>
					</div>
				</form>
