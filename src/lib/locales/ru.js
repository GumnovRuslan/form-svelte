let ru = {
	home: {
		title: 'Скоро здесь откроется платформа для предпринимателей и их клиентов.',
		subtitle: ["Мы как пчелы", 'все еще работаем над запуском нашего улья.', 'buh-buh-buh'],
		description: 'Зарегистрируйтесь сейчас, чтобы быть в числе первых, кто максимизирует влияние на ваш бизнес.',
		button: 'Регистрация'
	},
	form: {
		title: 'Регистрация',
		...
		category: {
			...
			default_subcategory: 'Выберите подкатегорию',
		...
		workMode: {
			title: 'Режим работы',
			text_time: 'Время работы',
			text_buttons: 'Применить к',
			button_all: 'Всем дням',
